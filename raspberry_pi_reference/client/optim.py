    ...
    def step(self, closure=None):
        ...
        for group in self.param_groups:
            ...
            for p in group['params']:
                ...
                # add_(alpha, x) means += alpha * x (in-place)
...
class NAG_SGD(Optimizer):
    ...
    def set_initial_buffer_FedNAG(self, initial_buffer):
        r""".
            .. warning::
                Parameters need to be specified as collections that have a deterministic
                ordering that is consistent between runs. Examples of objects that don't
        ...
        for group in self.param_groups:
            for i,p in enumerate(group['params']):
                ...
                self.state[p]['momentum_buffer'].copy_(initial_buffer[i])
...
class FastSlowMo_SGD(Optimizer):
    ...
    def set_initial_buffer_FastSlowMo(self, initial_buffer):
        r""".
            .. warning::
                Parameters need to be specified as collections that have a deterministic
                ordering that is consistent between runs. Examples of objects that don't
...
class DOMO_SGD(Optimizer):
    ...
    def set_initial_buffer_DOMO(self, initial_buffer):
        r""".
            .. warning::
                Parameters need to be specified as collections that have a deterministic
                ordering that is consistent between runs. Examples of objects that don't
        ...
        for keys in initial_buffer:
            if 'weight' in keys:
                initial_param_groups.append(initial_buffer[keys])
            if 'bias' in keys:
                initial_param_groups.append(initial_buffer[keys])
...
class MIME_SGD(Optimizer):
    ...
    def set_initial_buffer_MIME(self, initial_buffer):
        r""".
            .. warning::
                Parameters need to be specified as collections that have a deterministic
                ordering that is consistent between runs. Examples of objects that don't
        ...
        for group in self.param_groups:
            for i,p in enumerate(group['params']):
                ...
                self.state[p]['momentum_buffer']=initial_buffer[i]
...
class FedM_SGD(Optimizer):
    ...
    def set_initial_grad(self, initial_params):
        r""".
            .. warning::
                Parameters need to be specified as collections that have a deterministic
                ordering that is consistent between runs. Examples of objects that don't
